import { FaCheck, FaLocationArrow, FaBed, FaBath, FaRulerCombined, FaTimes } from "react-icons/fa";
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                ...
                >
                    {property.amenities.map((amenity, index) => {
                        return (
                            <li key={index}><FaCheck className="text-green-600 mr-2 mt-3" /> {amenity}</li>
                        )
                    })}
                </ul>
            </div>
