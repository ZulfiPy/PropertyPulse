            ...
            <div className="p-4">
                ...
                >
                    {property.rates.nightly && (
                        <p>
                            <FaMoneyBill className="inline" /> {property.rates.nightly}$ Nightly
                        </p>
                    )}

                    {property.rates.weekly && (
                        <p>
                            <FaMoneyBill className="inline" /> {property.rates.weekly}$ Weekly
                        </p>
                    )}

                    {property.rates.monthly && (
                        <p>
                            <FaMoneyBill className="inline" /> {property.rates.monthly}$ Monthly
                        </p>
                    )}
                </div>
